      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col lg:flex-row gap-4 lg:gap-10 p-6">
        ...
        <div className="w-full max-w-xl p-1 flex flex-col gap-4 lg:gap-10">
          <p className="font-normal text-base lg:text-lg">
            Introducing Tech City Phase 1&2 Where Luxury Meets Afordability and
            Innovation
          </p>
          <p className="font-normal text-base lg:text-lg">
          ...
          <p className="font-normal text-base lg:text-lg">
            ...
            fats ofer the perfect blend of space, sophis￾ca￾on, and innova￾on.
          ...
          <p className="font-normal text-base lg:text-lg">
            At Tech City, we're commi￾ed to providing a holis￾c living
            experience that combines comfort, convenience, and afordability. Our
            estate ofers:
          </p>
